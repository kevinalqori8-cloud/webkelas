					...
					<div class="mb-6 md:mb-0">
						<a href="#" class="flex items-center">
							<img
								src="/pp.png"
								alt=""
								className="h-[4.5rem] w-[4.5rem] right-2 relative rounded"
							/>
					...
					<div class="grid grid-cols-2 sm:grid-cols-3">
						<div className=" ">
							...
							<ul class="text-gray-400 dark:text-gray-400 font-medium">
								<li class="mb-2">
									<a href="https://www.instagram.com/stillbe.veeyn/?hl=id" class="hover:underline">
										Kepinn
									</a>
								</li>
						...
						<div className="">
							...
							<ul class="text-gray-400 dark:text-gray-400 font-medium">
								<li class="mb-2">
									<a href="https://www.instagram.com/xe4_ever/?hl=id" class="hover:underline ">
										Instagram
									</a>
								</li>
				...
				<div class="sm:flex sm:items-center sm:justify-between">
					<div class="flex mt-4 justify-center sm:mt-0">
						<p className="text-[0.7rem] text-white opacity-70">
							© {new Date().getFullYear()} Kelas XE - 4 | Di Kelola Oleh Siswa XE4
						</p>
					</div>
				</div>
			</div>
